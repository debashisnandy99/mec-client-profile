      ...
      <Card.Body>
        <div className="d-flex align-items-center">
          ...
          <div>
            ...
            <p className={`${LeftCss.genderFont} mb-0 text-muted`}>{gender[user.gender]}</p>
            <div className="mt-2">
        ...
        <div className="py-9">
          ...
          <div className="d-flex align-items-center justify-content-between mb-2">
            <span className={`${LeftCss.genderFont} mr-2`}>State:</span>
            <span className={`${LeftCss.genderFont} text-muted`}>{user.state}</span>
          </div>
        </div>
        {[
          "Contact Information",
